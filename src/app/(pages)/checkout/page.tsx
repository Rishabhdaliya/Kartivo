      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-6">
          ...
          <nav className="text-sm text-muted-foreground">
            <span>Home</span> <span className="mx-2">›</span> <span>Checkout</span>
          </nav>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2 bg-card border-border">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-foreground">Billing Details</CardTitle>
            </CardHeader>
          ...
          <Card className="lg:col-span-1 bg-card border-border h-fit">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl font-bold text-foreground">Your Order</CardTitle>
            </CardHeader>
                ...
                <RadioGroup value={shippingOption} onValueChange={setShippingOption}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="delivery-today" id="delivery-today" />
                      <Label htmlFor="delivery-today" className="text-muted-foreground">
                        Delivery: Today
                      </Label>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="delivery-7-days" id="delivery-7-days" />
                      <Label htmlFor="delivery-7-days" className="text-muted-foreground">
                        Delivery: 7 Days
                      </Label>
                    </div>
                    <span className="font-medium text-primary">
              ...
              <div className="space-y-4 w-full mb-4">
                <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="credit-card" className="text-muted-foreground">
                      Credit Card
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="cash-on-delivery" id="cash-on-delivery" />
                    <Label htmlFor="cash-on-delivery" className="text-muted-foreground">
                      Cash on Delivery
                    </Label>
                  </div>
                </RadioGroup>
